...
export default function PatientRegistration() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (
    ...
    } else if (!fileInput.files[0].type.match("image/jpeg")) {
      document.getElementById("fileFormatError").classList.remove("d-none");
    } else {
      ...
      try {
        const response = await fetch(
          "http://localhost:8010/patientRegistration",
          {
            method: "post",
            body: formData,
          }
        ...
        >
          ...
          >
            ...
            <div className="form-check-inline w-100">
              ...
              <p id="fileSizeError" className="text-danger d-none">
                Please select an image under 2MB.
              </p>
              <p id="fileFormatError" className="text-danger d-none">
            ...
            <button className="btn btn-primary w-25 offset-9" type="submit">
              Submit
            </button>
          </form>
        </div>
